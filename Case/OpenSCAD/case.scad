...
module enclosure(){
    difference(){
        union(){
            difference(){
                union(){
                    translate([-39,-84,0]) linear_extrude(height=base+38, center = false, convexity = 200) offset(r=wall+gap) import (file = "pcb.dxf");
                    translate([0,88.9+wall,2]) wallFastening();
                }
                translate([-39,-84,0]) translate([0,0,base]) linear_extrude(height=38, center = false, convexity = 200) offset(r=gap)  import (file = "pcb.dxf");
...
module blowProtection(){
    difference(){
         translate([-39,-84,base]) linear_extrude(height = 14.5, center = false, convexity = 200) offset(r=-4)  import (file = "pcb.dxf");
        translate([-39,-84,base]) linear_extrude(height = 14.5, center = false, convexity = 200) offset(r=-5.4)  import (file = "pcb.dxf");
...
module lidBearingSkew(){
    difference(){
        offset(r=gap+1.6)  import (file = "pcb.dxf");
        offset(r=gap-1)  import (file = "pcb.dxf");
    }
}
...
module pcbBearing(){
    difference(){
        translate([-39,-84,0]) translate([0,0,base+15]) linear_extrude(height = 1.6, center = false, convexity = 200) offset(r=gap)  import (file = "pcb.dxf");
        translate([-39,-84,0]) translate([0,0,base+15]) linear_extrude(height = 1.6, center = false, convexity = 200) offset(r=gap-0.6)  import (file = "pcb.dxf");
    }
...
module pcbBearingSkew(){
    difference(){
        offset(r=gap+1.6) import (file = "pcb.dxf");
        offset(r=gap-2) import (file = "pcb.dxf");
    }
}
